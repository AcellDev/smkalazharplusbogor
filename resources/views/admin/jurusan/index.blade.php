        ...
        <div class="bg-white p-6 sm:p-8 rounded-[2rem] shadow-sm border border-slate-200/60 sticky top-28">
            ...
            <form action="/admin/jurusan/store" method="POST" enctype="multipart/form-data">
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        <label class="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">Dokumentasi Gambar <span class="text-[10px] text-slate-400 font-normal">(Bisa Pilih Banyak)</span></label>
                ...
                <div class="flex gap-4 items-start mb-4">
                    @php
                        ...
                        if (json_last_error() === JSON_ERROR_NONE && is_array($decoded)) {
                            ...
                            $firstGambar = $gambarRaw; // Pakai data string lama langsung
                        }
                    @endphp
