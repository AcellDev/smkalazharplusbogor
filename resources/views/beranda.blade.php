        ...
        <div class="text-center container mx-auto px-6 max-w-4xl relative z-10 w-full" data-aos="fade-up" data-aos-duration="1000">
            <div class="hidden sm:mb-8 sm:flex sm:justify-center">
                <div class="relative rounded-full px-4 py-1.5 text-sm leading-6 text-white ring-1 ring-white/30 backdrop-blur-sm bg-white/10 shadow-lg flex items-center">
                    ...
                    <a href="https://docs.google.com/forms/d/14L4rExcwHUGXKvj3Kw5iHZppzp_zo-Y6xxTkGdObJ84/edit?usp=drive_web&ouid=104615721425371177891" class="font-semibold text-yellow-400 border-l border-white/30 pl-2 ml-1 hover:text-yellow-300 transition-colors">Daftar Sekarang <span aria-hidden="true">→</span></a>
                </div>
            </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        <div class="lg:col-span-5 space-y-6">
            <div class="flex items-center space-x-3 text-sm">
                ...
                <span class="font-medium text-emerald-600">DKV</span>
            </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        <div class="lg:col-span-7 order-last lg:order-first">
            <div class="relative group">
                ...
                <div class="relative aspect-[16/10] overflow-hidden rounded-2xl bg-gray-100 shadow-md auto-carousel">
                    <img src="images/jurusan/mplb1.JPG" alt="OTKP Showcase 1" class="carousel-item absolute inset-0 w-full h-full object-cover transition-opacity duration-1000 ease-in-out opacity-100 transform group-hover:scale-105">
                    <img src="images/jurusan/mplb2.jpg" alt="OTKP Showcase 2" class="carousel-item absolute inset-0 w-full h-full object-cover transition-opacity duration-1000 ease-in-out opacity-0 transform group-hover:scale-105">
                    <img src="images/jurusan/mplb3.jpg" alt="OTKP Showcase 3" class="carousel-item absolute inset-0 w-full h-full object-cover transition-opacity duration-1000 ease-in-out opacity-0 transform group-hover:scale-105">
                    <img src="images/jurusan/mplb4.jpg" alt="OTKP Showcase 4" class="carousel-item absolute inset-0 w-full h-full object-cover transition-opacity duration-1000 ease-in-out opacity-0 transform group-hover:scale-105">
        ...
        <div class="lg:col-span-5 space-y-6">
            <div class="flex items-center space-x-3 text-sm">
                <span class="font-extrabold text-amber-500 tracking-wider">2025–2026</span>
                <span class="h-1 w-1 rounded-full bg-gray-300"></span>
                <span class="font-medium text-emerald-600">MPLB</span>
            </div>
            <h3 class="text-3xl lg:text-4xl font-extrabold text-gray-900 tracking-tight">
                    ...
                    <div class="space-y-8">
                        ...
                        <div class="flex gap-5 items-start">
                            ...
                            <div>
                                ...
                                <p class="text-green-50/70 leading-relaxed font-medium">+62 813-1869-0627</p>
                            </div>
                        </div>
                    </div>
                </div>
